...
const Footer = () => {
  return (
    <div className="max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-[#EEE5E9]">
      <div>
        ...
        <p className="py-4">
          ...
          ullam iusto est. Tenetur rem dolores odio quae sunt non beatae? Cum
          similique corporis debitis.
        </p>
